...
urlpatterns = [
    ...
    path('weekly-tracker/', views.weekly_tracker),
    path('weekly-tracker/tasks/<int:pk>/', views.weekly_tracker_task),
    path('weekly-tracker/tasks/<int:pk>/toggle/', views.weekly_tracker_toggle),
